    ...
    useEffect(() => {
        async function getCurrentUser(){
            ...
            try {
                ...
                const profilePictureResponse = await userService.getProfilePicture(response.user.id, authContext.token)
                setProfilePicture(profilePictureResponse.picture_content)
                console.log("Profile picture:", profilePictureResponse)
