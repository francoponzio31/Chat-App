...
from utilities.custom_exceptions import EntityNotFoundError, MemberAlreadyInChat
...
class ChatMembersController:
    ...
    def get_chat_members(self, chat_id:int) -> tuple[Response, int]:
        try:
            ...
            return jsonify({"success": True, "message": "Succesful search", "chat_members": chat_members}), 200
    ...
    def add_member(self) -> tuple[Response, int]:
        try:
            ...
            return jsonify({"success": True, "message": "Succesful creation", "chat_member": new_chat_member}), 200
