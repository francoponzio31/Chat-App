...
class ChatsController:
    ...
    @token_required
    def get_user_chats(self, user_id:int) -> Response:
        try:
            chats = chats_service.get_user_chats(user_id)
            return jsonify({"success": True, "message": "Succesful search", "chats": chats})
    ...
    def create_chat(self) -> Response:
        ...
        try:
            ...
            return jsonify({"success": True, "message": "Succesful creation", "chat": new_chat})
    ...
    @token_required
    def update_chat(self, chat_id:int) -> Response:
        try:
            updated_chat = chats_service.update_chat(chat_id, request.json)
            return jsonify({"success": True, "message": "Succesful update", "chat": updated_chat})
