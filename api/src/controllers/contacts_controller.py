...
class ContactsController:
    ...
    def get_user_contacts(self, user_id:int) -> Response:
        try:
            ...
            return jsonify({"success": True, "message": "Succesful search", "contacts": contacts})
    ...
    @token_required
    def create_contact(self) -> Response:
        try:        
            new_contact = contacts_service.create_contact(request.json)
            return jsonify({"success": True, "message": "Succesful creation", "contact": new_contact})
