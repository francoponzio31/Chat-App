...
class ContactsController:
    ...
    def get_user_contacts(self, user_id:int) -> tuple[Response, int]:
        try:
            ...
            return jsonify({"success": True, "message": "Successful search", "contacts": contacts}), 200
    ...
    def create_contact(self) -> tuple[Response, int]:
        try:        
            ...
            return jsonify({"success": True, "message": "Successful creation", "contact": new_contact}), 200
