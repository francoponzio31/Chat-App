...
class ChatsController:
    ...
    def get_user_chats(self, user_id:int) -> tuple[Response, int]:
        try:
            ...
            return jsonify({"success": True, "message": "Successful search", "chats": chats}), 200
    ...
    def create_chat(self) -> tuple[Response, int]:
        ...
        try:
            ...
            return jsonify({"success": True, "message": "Successful creation", "chat": new_chat}), 200
    ...
    def update_chat(self, chat_id:int) -> tuple[Response, int]:
        try:
            ...
            return jsonify({"success": True, "message": "Successful update", "chat": updated_chat}), 200
